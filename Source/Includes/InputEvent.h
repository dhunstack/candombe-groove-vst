...
public:
    ...
    void update(juce::Optional<juce::AudioPlayHead::PositionInfo> Pinfo,
                double sample_rate_, int64_t buffer_size_in_samples_, bool isFirstFrame, juce::AudioBuffer<float> &audioBuffer_) {
        ...
        audioBuffer = std::move(audioBuffer_);
    }


    void update(juce::Optional<juce::AudioPlayHead::PositionInfo> Pinfo, double sample_rate_,
                int64_t buffer_size_in_samples_, juce::MidiMessage &message_, juce::AudioBuffer<float> &audioBuffer_) {
